...
export default function ProgramDegreeRequirements() {
  return (
    <section className="w-full bg-sky-950 py-16 px-4 flex justify-center">
      <div className="max-w-[1480px] w-full flex flex-row items-center gap-14">
        {/* Left: Title */}
        <h2 className="text-white text-6xl font-medium font-['Halyard_Display'] leading-[100px] whitespace-nowrap">
          Degree Requirements
        </h2>
